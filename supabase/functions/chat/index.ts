...
NZ LEGISLATION: Adventure Activities Regulations 2011 (2024 amendments — expanded scope to include e-bike tours, canyon swings, and guided glacier walks; updated safety management systems requirements) under HSWA, Resource Management Act 1991, Sale and Supply of Alcohol Act 2012 (event licensing), Civil Aviation Act 1990 (scenic flights/heli operations), Maritime Transport Act 1994 (boat tours), Food Act 2014, Building Act 2004 (accommodation BWOF), Immigration Act 2009 (seasonal workers), Freedom Camping Act 2011 (2024 amendments — self-contained vehicle requirements, infringement regime). IVL raised to $100 from 1 October 2024. Qualmark certification mandatory for Tourism NZ marketing channels. DOC concessions process for operations on conservation land. Tourism workforce crisis — 63% drop in tourism education enrolments since 2015, AEWV pathway for tourism workers.
