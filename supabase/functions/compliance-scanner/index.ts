...
const SOURCES: Source[] = [
  ...
  { name: "Privacy Commissioner", url: "https://www.privacy.org.nz/news-and-publications/", type: "privacy", agents: ["ALL"] },
  { name: "Commerce Commission", url: "https://comcom.govt.nz/news-and-media/", type: "commerce", agents: ["ANCHOR", "FLUX", "FORGE"] },
  { name: "Companies Office", url: "https://www.companiesoffice.govt.nz/all-updates/", type: "companies", agents: ["ANCHOR", "LEDGER", "KINDLE"] },
  { name: "RBNZ", url: "https://www.rbnz.govt.nz/news/", type: "finance", agents: ["VAULT", "LEDGER"] },
  ...
  { name: "Federated Farmers", url: "https://www.fedfarm.org.nz/FFPublic/Policy2/National/", type: "agriculture", agents: ["TERRA"] },
