...
export const echoAgent: Agent = {
  ...
  name: "ECHO",
  designation: "ASM-000",
  role: "AI Executive Assistant & Business Co-Pilot",
  tagline: "Your AI Executive Assistant — answers calls, qualifies leads, manages email, schedules meetings, and creates world-class marketing content",
  color: "#E4A0FF",
  sector: "Founder",
...
export const agents: Agent[] = [
  {
    ...
    tagline: "The AI that runs your venue — cafes, restaurants, hotels, bars & lodges",
    color: "#00FF88",
    sector: "Hospitality",
  ...
  },
  {
    ...
    name: "HAVEN",
    designation: "ASM-018",
    role: "Property Intelligence Platform for NZ Real Estate",
  ...
  },
  {
    ...
    expertise: ["Employment agreement generator", "Payroll & PAYE calculator", "Holidays Act compliance AI", "H&S programme builder", "Recruitment pipeline manager", "Gateway test advisor", "Privacy IPP 3A compliance"],
    starters: ["Draft an employment agreement", "Calculate holiday pay", "Create a disciplinary process plan"],
  },
  {
    id: "spark",
    name: "SPARK",
