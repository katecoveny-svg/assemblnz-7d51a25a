...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    name: "FORGE",
    designation: "ASM-006",
    role: "Automotive & Dealership Intelligence Platform",
    tagline: "The complete dealership management platform for NZ",
    color: "#FF4D6A",
    sector: "Automotive",
    traits: ["Technical & precise", "Reg-savvy", "EV-ready"],
    expertise: ["NZTA WoF/CoF", "Clean Car Standard", "MTA standards", "Workshop compliance", "EV transition", "Dealership operations", "Vehicle sales", "Parts & service"],
    starters: ["Help me list a vehicle on TradeMe", "Generate a sales meeting agenda", "Create a service menu for my workshop"],
  },
  {
    id: "architecture",
    name: "ARC",
