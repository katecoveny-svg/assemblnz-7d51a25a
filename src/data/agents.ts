...
export const agents: Agent[] = [
  {
    ...
    name: "AURA",
    designation: "ASM-001",
    role: "Hospitality Management Partner",
  ...
  },
  {
    ...
    name: "APEX",
    designation: "ASM-003",
    role: "Construction Compliance Expert",
  ...
  },
  {
    ...
    name: "TERRA",
    designation: "ASM-004",
    role: "Farm Business Advisor",
    tagline: "Biosecurity requirements, WorkSafe obligations for farms, and employment law for seasonal workers — all in one place.",
    color: "#7CFF6B",
    sector: "Agriculture",
  ...
  },
  {
    ...
    name: "PULSE",
    designation: "ASM-005",
    role: "Your Retail Operations Advisor",
  ...
  },
  {
    ...
    name: "FORGE",
    designation: "ASM-006",
    role: "Automotive Operations Advisor",
    tagline: "Workshop compliance, consumer guarantees, and employment law for the automotive trade — sorted in minutes.",
    color: "#FF4D6A",
    sector: "Automotive",
  ...
  },
  {
    ...
    name: "FLUX",
    designation: "ASM-008",
    role: "Your Sales & Revenue Advisor",
  ...
  },
  {
    ...
    name: "NEXUS",
    designation: "ASM-009",
    role: "Customs & Trade Compliance Advisor",
    tagline: "Import/export documentation, tariff classifications, and NZ Customs requirements — without calling your broker every time.",
    color: "#5B8CFF",
  ...
  },
  {
    ...
    name: "AXIS",
    designation: "ASM-010",
    role: "Your Project & Operations Advisor",
  ...
  },
  {
    ...
    name: "VITAE",
    designation: "ASM-012",
    role: "Your Health Practice Advisor",
  ...
  },
  {
    ...
    name: "HELM",
    designation: "ASM-013",
    role: "Family Life Admin Manager",
  ...
  },
  {
    ...
    tagline: "NZ law in plain English — contracts, employment disputes, privacy policies, and separation guidance. Not a substitute for a lawyer.",
    color: "#00E5FF",
  ...
  },
  {
    ...
    name: "SIGNAL",
    designation: "ASM-016",
    role: "Your IT Security & Digital Advisor",
  ...
  },
  {
    ...
    tagline: "Navigating NZQA requirements, teacher registration, and school governance obligations — without the 200-page policy manual.",
    color: "#FFD54F",
  ...
  },
  {
    ...
    name: "HAVEN",
    designation: "ASM-018",
    role: "Property Intelligence Advisor",
    tagline: "Stay across Healthy Homes compliance so a $7,200 fine doesn't show up on your next Tenancy Tribunal notice.",
    color: "#FF80AB",
    sector: "Property & Real Estate",
    traits: ["Market-savvy", "Regulation-sharp", "Investor-friendly", "Developer-ready"],
    expertise: ["Site viability screener", "Development appraisal generator", "Residual land value calculator", "Yield scenario modeller", "Investment memo writer", "Planning risk scorer", "Comparable sales finder", "Healthy Homes compliance", "Tenancy Tribunal guide", "Market demand analyser"],
    starters: ["Screen a development site for viability", "Generate a full development appraisal", "Write an investment memo for this property", "Analyse yield scenarios for my portfolio", "Score planning risk for a site", "Compare recent sales in my area"],
  },
  {
    id: "immigration",
    name: "COMPASS",
  ...
  },
  {
    ...
    name: "MARINER",
    designation: "ASM-021",
    role: "Maritime Operations Advisor",
    tagline: "Maritime NZ rules, crew safety obligations, and vessel compliance — translated from legislation into plain English.",
    color: "#26C6DA",
  ...
  },
  {
    ...
    name: "AROHA",
    designation: "ASM-038",
    role: "HR & Employment Advisor",
    tagline: "The employment questions you'd normally pay a lawyer $350/hour to ask — from KiwiSaver changes to restructuring processes.",
    color: "#FF6F91",
    sector: "HR & Employment",
    traits: ["Employment law expert", "People-focused", "Retention strategist"],
    expertise: ["Employment agreement generator", "Payroll & PAYE calculator", "Holidays Act compliance AI", "H&S programme builder", "Recruitment pipeline manager", "Gateway test advisor", "Privacy IPP 3A compliance", "Retention programme builder", "Incentive programme designer", "Engagement survey creator", "Salary benchmarking", "Exit interview generator"],
    starters: ["Build an employee incentive programme for my business", "Calculate the cost of staff turnover in my team", "Create a retention strategy for my top performers", "Generate an engagement survey for my staff", "Draft a professional development policy", "Help me build a career progression framework"],
  },
  {
    id: "spark",
    name: "SPARK",
    designation: "ASM-042",
    role: "No-Code App Builder",
    tagline: "Build custom business workflows — checklists, approval chains, compliance forms — without writing code or hiring a developer.",
    color: "#FF6B00",
  ...
  },
  {
    ...
    name: "TURF",
    designation: "ASM-043",
    role: "Sports Operations Advisor",
    tagline: "Your club's re-registration under the Incorporated Societies Act 2022. The deadline is 5 April 2026. Fewer than half of NZ's clubs have done it.",
    color: "#00E676",
  ...
  },
  {
    ...
    name: "CLINIC",
    designation: "ASM-045",
    role: "Dental & Veterinary Practice Advisor",
    tagline: "APC tracking, controlled substance records, patient recall, infection control audits, ACC claims — practice management intelligence for dental and veterinary clinics.",
    color: "#7E57C2",
    sector: "Health & Wellbeing",
    traits: ["Calm & precise", "Clinically aware", "Compliance-focused"],
    expertise: ["APC renewal tracking", "Patient recall systems", "ACC dental claims", "Controlled substance records", "Practice audit checklists", "Staff CPD tracking"],
    starters: ["When is my APC due for renewal?", "Draft a patient recall message", "Help me with an ACC dental claim", "What controlled substance records do I need to keep?", "Generate a practice audit checklist"],
  },
  {
    id: "pristine",
    name: "PRISTINE",
    designation: "ASM-046",
    role: "Commercial Cleaning Operations Advisor",
    tagline: "Quoting, scheduling, staff management, chemical compliance, and contract management — purpose-built for cleaning businesses.",
    color: "#26C6DA",
    sector: "Business Tools",
    traits: ["Organised & practical", "Efficiency-driven", "Safety-conscious"],
    expertise: ["Quote calculator", "Multi-site roster generation", "Chemical safety compliance", "Contract management", "Quality audit systems", "Tender responses"],
    starters: ["Quote a 500m² office clean, 3x per week", "Generate a cleaning roster for 4 sites", "What chemical safety records do I need?", "Draft a commercial cleaning contract", "Create a quality audit checklist"],
  },
  {
    id: "network",
    name: "NETWORK",
    ...
    tagline: "Franchise agreements, disclosure documents, operations manuals, network management, and benchmarking — for NZ franchise systems.",
    color: "#FF7043",
    sector: "Business Tools",
    traits: ["Strategic & structured", "Relationship-aware", "Systems-focused"],
    expertise: ["Franchise agreement drafting", "Disclosure documents", "Operations manual creation", "Network benchmarking", "Franchisee recruitment", "White-label platform"],
    starters: ["Is my business franchisable?", "Draft a franchise agreement", "Create a franchisee recruitment pack", "Benchmark my franchisee performance", "Generate a franchise disclosure document"],
  },
];
