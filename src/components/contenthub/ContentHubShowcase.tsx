...
const FEATURED = [
  { name: "ECHO", color: "#D4A843", id: "echo", title: "Content Workflow", desc: "Daily content queue, DM drafts, and performance analytics", Preview: EchoContentPreview },
  ...
  { name: "TORO", color: "#3A6A9C", id: "operations", title: "Family Weekly Planner", desc: "School timetable, bus routes, and events dashboard", Preview: HelmWeeklyPreview },
];
