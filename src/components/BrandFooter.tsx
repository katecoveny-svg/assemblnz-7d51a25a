    ...
    <footer className="relative py-20 pb-32 sm:pb-20 px-6 overflow-hidden" style={{ background: "hsl(var(--background))" }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex justify-center mb-14">
          ...
          >
            78 specialist agents · 9 industry kete · Built in Aotearoa
          </div>
        </div>
        ...
        <p
          ...
          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
        >
          Assembl provides automated business guidance powered by 78 specialist AI agents. Outputs should be verified by qualified professionals before reliance. assembl@assembl.co.nz · www.assembl.co.nz
        </p>
      </div>
    </footer>
  );
