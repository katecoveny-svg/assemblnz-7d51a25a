...
export const NeonBuilding = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <rect x="3" y="6" width="18" height="16" rx="2" stroke={C.green} strokeWidth="1.5" strokeOpacity="0.8" fill={`${C.green}14`} />
    <rect x="7" y="10" width="3" height="3" rx="0.5" fill={C.green} fillOpacity="0.5" />
    <rect x="14" y="10" width="3" height="3" rx="0.5" fill={C.green} fillOpacity="0.5" />
    <rect x="7" y="16" width="3" height="3" rx="0.5" fill={C.green} fillOpacity="0.5" />
    <rect x="14" y="16" width="3" height="3" rx="0.5" fill={C.green} fillOpacity="0.5" />
    <line x1="12" y1="2" x2="12" y2="6" stroke={C.green} strokeWidth="1.5" strokeOpacity="0.4" />
    <circle cx="12" cy="2" r="1" fill={C.green} opacity="0.8">
...
export const NeonFamily = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <circle cx="8" cy="6" r="3" stroke={C.lavender} strokeWidth="1.5" fill={`${C.lavender}1a`} />
    <circle cx="16" cy="6" r="3" stroke={C.lavender} strokeWidth="1.5" fill={`${C.lavender}1a`} />
    <circle cx="12" cy="14" r="2.5" stroke={C.pink} strokeWidth="1.5" fill={`${C.pink}1a`} />
    <path d="M4 20c0-2.2 1.8-4 4-4M20 20c0-2.2-1.8-4-4-4" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.6" strokeLinecap="round" />
    <path d="M8.5 20c0-1.9 1.6-3.5 3.5-3.5s3.5 1.6 3.5 3.5" stroke={C.pink} strokeWidth="1.5" strokeOpacity="0.6" strokeLinecap="round" />
  </svg>
);

export const NeonHammer = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M6 18L14 10" stroke={C.orange} strokeWidth="2" strokeLinecap="round" />
    <rect x="12" y="4" width="8" height="6" rx="1.5" transform="rotate(15 16 7)" stroke={C.orange} strokeWidth="1.5" fill={`${C.orange}26`} />
    <circle cx="6" cy="18" r="1.5" fill={C.orange} opacity="0.6">
...
export const NeonSeedling = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M12 22V12" stroke={C.green} strokeWidth="1.5" strokeLinecap="round" />
    <path d="M12 12C12 8 16 6 18 4C18 8 16 10 12 12Z" fill={`${C.green}26`} stroke={C.green} strokeWidth="1.5" />
    <path d="M12 15C12 11 8 9 6 7C6 11 8 13 12 15Z" fill={`${C.green}1a`} stroke={C.green} strokeWidth="1.5" strokeOpacity="0.6" />
    <circle cx="12" cy="22" r="1" fill={C.green} opacity="0.5" />
  </svg>
);

export const NeonClipboard = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonDocument = ({ size = 24, color = C.blue }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonMegaphone = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M18 4L8 8H4v6h4l10 4V4z" stroke={C.pink} strokeWidth="1.5" fill={`${C.pink}1a`} />
    <path d="M20 9v4" stroke={C.pink} strokeWidth="1.5" strokeLinecap="round" strokeOpacity="0.6" />
    <circle cx="20" cy="7" r="1" fill={C.pink} opacity="0.5">
...
export const NeonTeam = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <circle cx="9" cy="7" r="3" stroke={C.green} strokeWidth="1.5" fill={`${C.green}14`} />
    <circle cx="17" cy="9" r="2.5" stroke={C.cyan} strokeWidth="1.5" fill={`${C.cyan}14`} />
    <path d="M3 20c0-3.3 2.7-6 6-6s6 2.7 6 6" stroke={C.green} strokeWidth="1.5" strokeOpacity="0.6" strokeLinecap="round" />
    <path d="M15 20c0-2.2 1.8-4 4-4" stroke={C.cyan} strokeWidth="1.5" strokeOpacity="0.4" strokeLinecap="round" />
  </svg>
);
...
export const NeonFactory = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <rect x="2" y="12" width="20" height="10" rx="1" stroke={C.orange} strokeWidth="1.5" fill={`${C.orange}0f`} />
    <path d="M6 12V6l4 3V6l4 3V6l4 3v3" stroke={C.orange} strokeWidth="1.5" strokeOpacity="0.7" />
    <rect x="5" y="16" width="3" height="3" rx="0.5" fill={C.orange} fillOpacity="0.3" />
    <rect x="10" y="16" width="3" height="3" rx="0.5" fill={C.orange} fillOpacity="0.3" />
    <circle cx="18" cy="4" r="1" fill={C.orange} opacity="0.4">
      <animate attributeName="opacity" values="0.4;0.1;0.4" dur="3s" repeatCount="indefinite" />
    </circle>
    <line x1="18" y1="5" x2="18" y2="9" stroke={C.orange} strokeWidth="1" strokeOpacity="0.3" />
  </svg>
);

export const NeonWave = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M2 12c2-3 4-3 6 0s4 3 6 0 4-3 6 0" stroke={C.green} strokeWidth="1.5" strokeLinecap="round" fill="none" />
    <path d="M2 16c2-2 4-2 6 0s4 2 6 0 4-2 6 0" stroke={C.green} strokeWidth="1" strokeLinecap="round" strokeOpacity="0.4" fill="none" />
    <circle cx="12" cy="6" r="2" fill={`${C.green}33`} stroke={C.green} strokeWidth="1" />
  </svg>
);
...
// ── HELM-specific icons (lavender) ──

export const NeonFork = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M7 2v7c0 1.7 1.3 3 3 3h1v9" stroke={C.lavender} strokeWidth="1.5" strokeLinecap="round" strokeOpacity="0.8" />
    <line x1="7" y1="2" x2="7" y2="7" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.5" />
    <line x1="9" y1="2" x2="9" y2="7" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.5" />
    <line x1="11" y1="2" x2="11" y2="7" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.5" />
    <path d="M17 2v4a3 3 0 01-3 3v0" stroke={C.lavender} strokeWidth="1.5" strokeLinecap="round" strokeOpacity="0.6" />
    <line x1="17" y1="9" x2="17" y2="21" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.4" />
  </svg>
);

export const NeonGift = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <rect x="3" y="10" width="18" height="12" rx="2" stroke={C.lavender} strokeWidth="1.5" fill={`${C.lavender}0f`} />
    <rect x="3" y="7" width="18" height="4" rx="1" stroke={C.lavender} strokeWidth="1.5" fill={`${C.lavender}1a`} />
    <line x1="12" y1="7" x2="12" y2="22" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.4" />
    <path d="M12 7C12 7 9 4 7 4c-1.1 0-2 .9-2 2s.9 2 2 2" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.6" strokeLinecap="round" />
    <path d="M12 7c0 0 3-3 5-3 1.1 0 2 .9 2 2s-.9 2-2 2" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.6" strokeLinecap="round" />
  </svg>
);

export const NeonShirt = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M8 2l-5 5 3 2 1-2v13a1 1 0 001 1h8a1 1 0 001-1V7l1 2 3-2-5-5" stroke={C.lavender} strokeWidth="1.5" fill={`${C.lavender}0a`} strokeLinecap="round" strokeLinejoin="round" />
    <path d="M9 2a3 3 0 006 0" stroke={C.lavender} strokeWidth="1.5" strokeOpacity="0.5" />
  </svg>
);

export const NeonPaw = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <ellipse cx="12" cy="16" rx="4" ry="3" fill={`${C.lavender}1a`} stroke={C.lavender} strokeWidth="1.5" />
    <circle cx="7" cy="10" r="2" fill={`${C.lavender}26`} stroke={C.lavender} strokeWidth="1.2" />
    <circle cx="17" cy="10" r="2" fill={`${C.lavender}26`} stroke={C.lavender} strokeWidth="1.2" />
    <circle cx="10" cy="7" r="1.5" fill={`${C.lavender}26`} stroke={C.lavender} strokeWidth="1.2" />
    <circle cx="14" cy="7" r="1.5" fill={`${C.lavender}26`} stroke={C.lavender} strokeWidth="1.2" />
  </svg>
);

export const NeonCalendar = ({ size = 24, color = C.lavender }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonHome = ({ size = 24, color = C.lavender }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonCar = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M5 15h14l1.5-5H3.5L5 15z" stroke={C.lavender} strokeWidth="1.5" fill={`${C.lavender}0a`} />
    <rect x="3" y="15" width="18" height="4" rx="1" stroke={C.lavender} strokeWidth="1.5" fill={`${C.lavender}0f`} />
    <circle cx="7" cy="19" r="2" stroke={C.lavender} strokeWidth="1.5" fill="hsl(var(--background))" />
    <circle cx="17" cy="19" r="2" stroke={C.lavender} strokeWidth="1.5" fill="hsl(var(--background))" />
  </svg>
);

export const NeonBell = ({ size = 24, color = C.lavender }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonCheckmark = ({ size = 24, color = C.green }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonSearch = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonShield = ({ size = 24, color = C.green }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonRefresh = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonChart = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonMail = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonBox = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonGlobe = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonPen = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonTimer = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonWrench = ({ size = 24, color = C.orange }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonAnchor = ({ size = 24, color = C.teal }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonFish = ({ size = 24, color = C.teal }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonSailboat = ({ size = 24, color = C.teal }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonFitness = ({ size = 24, color = C.red }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonRunning = ({ size = 24, color = C.red }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonYoga = ({ size = 24, color = C.teal }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonSleep = ({ size = 24, color = C.blue }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonSalad = ({ size = 24, color = C.lime }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonCart = ({ size = 24, color = C.lime }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonParty = ({ size = 24, color = C.gold }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <circle cx="20" cy="8" r="1" fill={C.pink} opacity="0.5" />
    <circle cx="19" cy="3" r="0.8" fill={C.green} opacity="0.5" />
  </svg>
);

export const NeonCouple = ({ size = 24, color = C.pink }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonMap = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonReturn = ({ size = 24, color = C.cyan }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonBuilding2 = ({ size = 24, color = C.green }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonSiren = ({ size = 24, color = C.red }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonSafetyVest = ({ size = 24, color = C.orange }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonChild = ({ size = 24, color = C.pink }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonUpload = ({ size = 24, color = C.blue }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonIncrease = ({ size = 24, color = C.green }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const NeonNZFlag = ({ size = 24 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <rect x="2" y="4" width="20" height="16" rx="2" stroke={C.cyan} strokeWidth="1.5" fill={`${C.cyan}0a`} />
    <circle cx="15" cy="9" r="1" fill={C.red} opacity="0.8" />
    <circle cx="17" cy="11" r="0.8" fill={C.red} opacity="0.7" />
    <circle cx="16" cy="14" r="0.9" fill={C.red} opacity="0.75" />
    <circle cx="18" cy="8" r="0.7" fill={C.red} opacity="0.65" />
    <rect x="2" y="4" width="8" height="7" stroke={C.blue} strokeWidth="1" fill={`${C.blue}14`} />
  </svg>
);
