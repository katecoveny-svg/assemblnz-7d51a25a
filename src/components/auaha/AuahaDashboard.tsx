        ...
        <GlassCard className="lg:col-span-3 p-6">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={sparkData}>
              ...
              <YAxis hide />
              <Tooltip contentStyle={{ background: 'rgba(15,15,26,0.95)', border: '1px solid rgba(240,208,120,0.2)', borderRadius: 12, color: '#3D4250', fontSize: 12, boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}
