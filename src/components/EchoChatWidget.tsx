  ...
  return (
    <>
      ...
      {open && minimized && (
        ...
        >
          <img src={assemblMark} alt="Echo" className="w-6 h-6 object-contain logo-glow" />
      ...
      {open && !minimized && (
        ...
        >
          ...
          <header className="flex items-center gap-2.5 px-4 py-3 shrink-0" style={{ borderBottom: `1px solid ${ECHO_BORDER}` }}>
            <img src={assemblMark} alt="Echo" className="w-7 h-7 object-contain logo-glow" />
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            {messages.map((msg, i) => (
              <div key={i} className={`flex gap-2 mb-3 ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                {msg.role === "assistant" && <img src={assemblMark} alt="" className="w-5 h-5 object-contain shrink-0 mt-1" />}
                <div
