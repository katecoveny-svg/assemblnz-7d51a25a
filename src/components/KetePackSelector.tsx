...
const KETE_PACKS = [
  ...
  },
  {
    ...
    sub: "Automotive",
    wananga: "Te Kete Tuauri",
    wanangaEn: "Movement & machinery",
    icon: Car,
    to: "/kete/arataki",
    color: "#E8E8E8",
    agents: "12 agents",
    desc: "Vehicle compliance, WOF, RUC, fleet, workshop, dealer management.",
  },
  {
    name: "Pikau",
    sub: "Freight & Customs",
    wananga: "Te Kete Tuauri",
    wanangaEn: "Trade & logistics",
    icon: Package,
    to: "/pikau",
    color: "#7ECFC2",
    agents: "10 agents",
    desc: "Customs, biosecurity, import/export compliance, freight, logistics.",
  },
  {
    name: "Toro",
