...
const WalkthroughViewer = ({ glbUrl, color = "#00FF88" }: WalkthroughViewerProps) => {
  ...
  return (
    <div ref={containerRef} className="relative w-full rounded-lg overflow-hidden" style={{ background: "#0A0A14" }}>
      {/* Controls overlay */}
      <div className="absolute top-3 left-3 z-10 flex items-center gap-2">
        <div className="px-3 py-1.5 rounded-full text-[10px] font-mono"
          style={{ background: "rgba(0,255,136,0.1)", color, border: `1px solid ${color}30` }}>
