...
const FEATURES = [
  ...
  { icon: <Share2 size={24} />, color: "#FF2D9B", title: "Social Media", desc: "Full weekly content calendars with posting times, hashtags, A/B tests, and engagement strategies for Instagram and LinkedIn." },
