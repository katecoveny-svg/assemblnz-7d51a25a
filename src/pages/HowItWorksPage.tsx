...
const KETE = [
  ...
  { name: "Arataki", sub: "Business Operations", color: C.navy, accentLight: "#4A7AB5", to: "/contact",
    desc: "Dealership compliance, finance disclosure, and customer enquiry — the showroom back office handled.",
